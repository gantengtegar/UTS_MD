package id.tegar.catatanpenjualan.activity._main
...
import id.tegar.catatanpenjualan.R
import id.tegar.catatanpenjualan.activity._main.adapter.MenuAdapter
import id.tegar.catatanpenjualan.activity._main.presenter.MainPresenter
import id.tegar.catatanpenjualan.activity._main.presenter.MainView
import id.tegar.catatanpenjualan.activity.data_barang.DataBarangActivity
import id.tegar.catatanpenjualan.activity.login.LoginActivity
import id.tegar.catatanpenjualan.activity.penjualan.PenjualanBarang
import id.tegar.catatanpenjualan.activity.report.ReportActivity
import id.tegar.catatanpenjualan.base.BaseActivity
import id.tegar.catatanpenjualan.model.Keranjang
import id.tegar.catatanpenjualan.utils.Uang
