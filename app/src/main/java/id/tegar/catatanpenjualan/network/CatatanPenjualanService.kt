package id.tegar.catatanpenjualan.network

import id.tegar.catatanpenjualan.activity.data_barang.data.ResultDataBarang
import id.tegar.catatanpenjualan.activity.login.data.ResultLogin
import id.tegar.catatanpenjualan.activity.penjualan.data.ResultKeranjang
import id.tegar.catatanpenjualan.activity.penjualan.data.ResultSearchBarang
import id.tegar.catatanpenjualan.activity.report.detail.data.ResultItemKeranjang
import id.tegar.catatanpenjualan.response.ResultSimple
